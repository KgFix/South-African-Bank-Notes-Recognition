# COMP702 — South African Bank Note Recognition
...
```
.
├── 702Project.ipynb       # Main notebook — run this
...
1. Open [Google Colab](https://colab.research.google.com/) and upload `702Project.ipynb`, or open it directly from GitHub via the Colab interface.
2. Upload the `dataset/` folder to `MyDrive/COMP702/dataset/` in your Google Drive.
...
```bash
jupyter notebook 702Project.ipynb
```
